...
export const POLICY: ReadonlyArray<FieldRow> = [
  ...
  { path: "lifecycle_rule.action.storage_class", role: "Tuning", pillar: "Performance", visibility: "RileyVisible", edit: "ChatSafe", sensitivity: "Public", changeRisk: "Unknown" },
  { path: "lifecycle_rule.action.type", role: "Tuning", pillar: "Reliability", visibility: "RileyVisible", edit: "ChatSafe", sensitivity: "Public", changeRisk: "Unknown" },
  { path: "lifecycle_rule.condition.age", role: "Tuning", pillar: "None", visibility: "RileyVisible", edit: "ChatSafe", sensitivity: "Public", changeRisk: "Unknown" },
  { path: "lifecycle_rule.condition.with_state", role: "Tuning", pillar: "None", visibility: "RileyVisible", edit: "ChatSafe", sensitivity: "Public", changeRisk: "Unknown" },
