...
func (c *Client) ListAvailableComponentKeys() ([]string, error) {
	...
	allKeys := []ComponentKey{
		...
		KeyAWSOpenSearch, KeyAWSBedrock, KeyAWSBedrockAgent, KeyAWSAgentCoreGateway, KeyAWSKendra, KeyAWSSQS, KeyAWSMSK, KeyAWSCloudWatchLogs, KeyAWSCloudWatchMonitoring,
