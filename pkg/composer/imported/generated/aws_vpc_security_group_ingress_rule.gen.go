...
// AWSVPCSecurityGroupIngressRule is the generated Layer 1 typed model for the
// `aws_vpc_security_group_ingress_rule` Terraform resource.
type AWSVPCSecurityGroupIngressRule struct {
...
// AWSVPCSecurityGroupIngressRuleSchema describes provider metadata for each attribute / nested
// block of aws_vpc_security_group_ingress_rule.
var AWSVPCSecurityGroupIngressRuleSchema = map[string]FieldSchema{
...
func init() {
	Register("aws_vpc_security_group_ingress_rule", reflect.TypeFor[AWSVPCSecurityGroupIngressRule](), AWSVPCSecurityGroupIngressRuleSchema, AWSProviderSource)
}
