...
var categoryByTFType = map[string]string{
	...
	"aws_cloudfront_origin_access_identity":              CategoryNetworkSecurity,
	...
	"aws_cloudwatch_log_resource_policy":                 CategoryObservability,
	"aws_cloudwatch_log_stream":                          CategoryObservability,
	...
	"aws_ecs_cluster_capacity_providers":                 CategoryVirtualMachines,
	"aws_eip":                                            CategoryNetworkSecurity,
	"aws_eks_access_entry":                               CategorySecurity,
	"aws_eks_addon":                                      CategoryVirtualMachines,
	"aws_eks_cluster":                                    CategoryVirtualMachines,
	"aws_eks_fargate_profile":                            CategoryVirtualMachines,
	"aws_eks_node_group":                                 CategoryVirtualMachines,
	"aws_eks_pod_identity_association":                   CategorySecurity,
	"aws_elasticache_parameter_group":                    CategoryDataStorage,
	"aws_elasticache_replication_group":                  CategoryDataStorage,
	"aws_elasticache_subnet_group":                       CategoryDataStorage,
	"aws_elb":                                            CategoryNetworkSecurity,
	"aws_iam_group":                                      CategorySecurity,
	...
	"aws_key_pair":                                       CategorySecurity,
	"aws_kms_alias":                                      CategorySecurity,
	...
	"aws_launch_template":                                CategoryVirtualMachines,
	"aws_lb":                                             CategoryNetworkSecurity,
	"aws_lb_listener":                                    CategoryNetworkSecurity,
	"aws_lb_target_group":                                CategoryNetworkSecurity,
	"aws_msk_cluster":                                    CategoryDataStorage,
	"aws_msk_configuration":                              CategoryDataStorage,
	...
	"aws_s3_bucket_lifecycle_configuration":              CategoryDataStorage,
	"aws_s3_bucket_ownership_controls":                   CategoryDataStorage,
	"aws_s3_bucket_policy":                               CategoryDataStorage,
	"aws_s3_bucket_public_access_block":                  CategoryDataStorage,
	"aws_s3_bucket_server_side_encryption_configuration": CategoryDataStorage,
	"aws_s3_bucket_versioning":                           CategoryDataStorage,
	...
	"google_cloud_run_v2_service_iam_member":                CategorySecurity,
	...
	"google_cloudfunctions2_function_iam_member":            CategorySecurity,
	"google_compute_address":                                CategoryNetworkSecurity,
	"google_compute_backend_service":                        CategoryNetworkSecurity,
	...
	"google_compute_health_check":                           CategoryNetworkSecurity,
	"google_compute_instance":                               CategoryVirtualMachines,
	"google_compute_managed_ssl_certificate":                CategoryNetworkSecurity,
	"google_compute_network":                                CategoryNetworkSecurity,
	"google_compute_resource_policy":                        CategoryDataStorage,
	...
	"google_compute_target_http_proxy":                      CategoryNetworkSecurity,
	...
	"google_identity_platform_default_supported_idp_config": CategorySecurity,
	"google_kms_crypto_key":                                 CategorySecurity,
	"google_kms_crypto_key_iam_binding":                     CategorySecurity,
	...
	"google_project_iam_member":                             CategorySecurity,
	"google_project_service":                                CategorySecurity,
	...
	"google_service_networking_connection":                  CategoryNetworkSecurity,
	...
	"google_vpc_access_connector":                           CategoryNetworkSecurity,
}
