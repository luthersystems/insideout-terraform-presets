...
//
// The InsideOut backend is the credentials/transport/session shell that
// calls into this package: it owns auth, role assumption, HTTP route
// handlers, agent/chat session plumbing, and drift-surface bookkeeping.
// The SDK calls themselves happen here, against typed inputs and outputs,
// with a credentials/client object the caller owns.
//
...
// tables, extractors, and SDK code currently living in the InsideOut
// backend.
